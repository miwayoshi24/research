...
def eval_bandit():
	...
	path_result_n_tweets_dir = setting['directory_for_result_n_tweets']
	...
	for area in areas:
		...
		if not os.path.isdir(path_result_n_tweets_dir + area):
			os.makedirs(path_result_n_tweets_dir + area)
